...
(ns app.rental-vehicles.backend.viewer.resolvers
...
(defresolver get-item
             ...
             ;
             ; @return (map)
             ;  {:rental-vehicles.viewer/get-item (namespaced map)}
             [env resolver-props]
             {:rental-vehicles.viewer/get-item (get-item-f env resolver-props)})
